...
if (useSass) {
    ...
    paths.styles = 'wwwroot/master/sass/';
}
...
var vendor = {
    ...
    base: {
        source: require('./wwwroot/master/vendor.base.json'),
        dest: 'wwwroot/app/js',
        name: 'base.js'
    },
    // vendor scripts to make the app work. Usually via lazy loading
    app: {
        source: require('./wwwroot/master/vendor.json'),
        dest: 'wwwroot/vendor'
    }
};
...
var compassOpts = {
    ...
    css: 'wwwwroot/app/css',
    sass: 'wwwwroot/master/sass/',
    image: 'wwwwroot/app/img'
};

var compassOptsThemes = {
    project: path.join(__dirname, '../'),
    css: 'wwwwroot/app/css',
    sass: 'wwwwroot/master/sass/themes/', // themes in a subfolders
    image: 'wwwwroot/app/img'
};
